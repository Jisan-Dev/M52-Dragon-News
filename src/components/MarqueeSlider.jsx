...
const MarqueeSlider = () => {
  return (
    <div className="p-4 bg-zinc-100 flex gap-2 items-center mt-7">
      <span className="py-3 px-6 bg-rose-600 text-white text-xl font-medium leading-none">Latest</span>
